...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(SITE_ROOT, "templates"), os.path.join(SITE_ROOT, "core", "templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
SOCIAL_AUTH_LOGIN_REDIRECT_URL = LOGIN_REDIRECT_URL = '/logged-in/'
SOCIAL_AUTH_LOGIN_ERROR_URL = LOGIN_ERROR_URL = '/login-error/'
SOCIAL_AUTH_USER_MODEL = AUTH_USER_MODEL = 'core.AppUser'
...
ANALYTICS_PROCESSING_REQUEST_CHOICE = 'Processing Request'
ANALYTICS_SENDING_EMAIL_CHOICE = 'Sending Email'
ANALYTICS_EMAIL_SENT_CHOICE = 'Email Sent'
