...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AppUser.unsubscribe'
        db.add_column(u'core_appuser', 'unsubscribe',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AppUser.unsubscribe'
        db.delete_column(u'core_appuser', 'unsubscribe')
    ...
    models = {
        u'core.appuser': {
            ...
            'send_mail_once': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
